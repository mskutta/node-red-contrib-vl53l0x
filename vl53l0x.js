...
module.exports = function(RED) {
    ...
    function setMeasurementTimingBudget(budget_us)
    {
        var enables = {}
        var timeouts = {}
    ...
    function setVcselPulsePeriod(type, period_pclks)
    {
    ...
    function getVcselPulsePeriod(type)
    {
        if (type == VcselPeriodPreRange)
        {
    ...
    function startContinuous(period_ms)
    {
        writeReg(0x80, 0x01);
        writeReg(0xFF, 0x01);
        writeReg(0x00, 0x00);
